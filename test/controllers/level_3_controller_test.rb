...
class Level3Test < ActionDispatch::IntegrationTest
    ...
    test "POST /buyers/:buyer_id/buy/:product_id permite a un comprador realizar una compra" do # 0.1 punto
    ...
    test "POST /buyers/:buyer_id/buy/:product_id permite la compra y actualiza la wallet" do # 0.3 punto
    ...
    test "POST /buyers/:buyer_id/buy/:product_id permite la compra y actualiza la disponibilidad del producto" do # 0.4 punto
    ...
    test "POST /buyers/:buyer_id/buy/:product_id no permite una compra sin suficiente dinero" do # 0.1 punto
    ...
    test "POST /buyers/:buyer_id/buy/:product_id no permite una compra si no existe el producto" do # 0.05 punto
        post "/buyers/#{@buyer1.id}/buy/99999"
        assert_response :not_found
    end

    test "POST /buyers/:buyer_id/buy/:product_id no permite una compra si no existe el comprador" do # 0.05 punto
        post "/buyers/99999/buy/#{@product1.id}"
        assert_response :not_found
    end

    test "GET /buyers/products/:buyer_id retorna los productos comprados por un comprador" do # 0.2 punto
        post "/buyers/#{@buyer1.id}/buy/#{@product1.id}"
    ...
    test "GET /buyers/products/:buyer_id retorna una lista vacía cuando el comprador no ha comprado productos" do # 0.1 punto
