...
class Level1Test < ActionDispatch::IntegrationTest
    ...
    test "GET /products/:id retorna producto existente" do # 0.05 punto
    ...
    test "GET /products/:id lanza error 404 para producto no existente" do # 0.05 punto
        get "/products/999"
        assert_response :not_found
    end

    test "POST /products/:brand_id crea un nuevo producto" do # 0.1 punto
    ...
    test "POST /products/:brand_id no crea un producto si la marca no existe" do # 0.1 punto
        product_params = { name: "Yogurt", description: "Yogurt de frutas", price: 15.0 }
        post "/products/999", params: { product: product_params }
        assert_response :unprocessable_entity
    end

    test "POST /products/:brand_id no crea un producto si faltan atributos" do # 0.1 punto
